...
class MyAttributes(object):
    ...
    def NonAction( method ):
        def wrapper( *args ):
            ...
            return method( *args )
        wrapper.isbeflamnonaction = True
        return wrapper
        
---
from beflam_attributes import BeflamAttributes

class Class1(object):

    @BeflamAttributes.NonAction
    def SayHello3(self,name:str)->str:
        return "Hi "+name+", here is Class1 SayHello3 from python beflam-api"
```
